---
trigger: glob
globs: **/*.bash,**/*.c,**/*.go,**/*.h,**/*.java,**/*.js,**/*.jsx,**/*.kt,**/*.kts,**/*.mjs,**/*.php,**/*.py,**/*.pyi,**/*.pyx,**/*.rb,**/*.scala,**/*.sh,**/*.swift,**/*.ts,**/*.tsx,**/*.yaml,**/*.yml
title: Zero Trust Architecture Implementation - Security principles for designing systems with no implicit trust
version: 1.3.0
---
